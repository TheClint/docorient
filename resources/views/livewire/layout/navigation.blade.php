...
<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('sessions.index')" :active="request()->routeIs('sessions.index')" wire:navigate>
                {{ __('Mes sessions') }}
            </x-responsive-nav-link>

            <x-responsive-nav-link :href="route('groupes.index')" :active="request()->routeIs('groupes.index')" wire:navigate>
                {{ __('Mes groupes') }}
            </x-responsive-nav-link>

            <x-responsive-nav-link :href="route('dashboard')" :active="request()->routeIs('documents.index')" wire:navigate>
                {{ __('Mes votes') }}
            </x-responsive-nav-link>
        </div>
